...
const RequestPlanMob = (props) => {
    ...
    return (React.createElement(RequestContainerMob, null,
        React.createElement("div", { className: !open ? "allRadius request-heading" : "request-heading", onClick: () => setOpen(!open) },
            React.createElement("p", null, "est\u00E1s solicitando..."),
            React.createElement("img", { className: open ? "active" : "", src: PlanArrow, alt: "arrow" })),
        React.createElement(motion.div, { className: "request-plan", variants: variantsOpen, initial: "close", animate: open ? "open" : "close" },
            React.createElement("div", { className: "container-imgplan" },
                formData.selectedPlan === undefined && (React.createElement("img", { src: Plan15gb, alt: "plan 15 gb" })),
...
export default connect(({ FormContent, ValidationContent }) => (Object.assign(Object.assign({}, FormContent), { ValidationContent })))(RequestPlanMob);
//# sourceMappingURL=RequestPlanMob.js.map